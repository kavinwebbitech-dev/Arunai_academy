<form id="EnquiryForm" action="{{ route('admin.enquiry.update', $enquiry->id) }}" method="POST">
    @csrf
    @method('PUT')
                ...
                <div class="col-md-12">
                    ...
                    <select name="subject" class="form-control">
                        ...
                        <optgroup label="UG Programs">
                            <option value="Botany UG" @selected($enquiry->subject == 'Botany UG')>Botany</option>
                        </optgroup>

                        <optgroup label="PG Programs">
                            <option value="Botany PG" @selected($enquiry->subject == 'Botany PG')>Botany</option>
                        </optgroup>

                        <option value="Other / General Enquiry" @selected($enquiry->subject == 'Other / General Enquiry')>
