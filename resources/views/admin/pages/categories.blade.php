    ...
    <div class="container mt-4">
        <div class="admin-card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0 fw-semibold">Add Gallery</h5>
                    ...
                    <tbody>
                        @foreach ($galleries as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('uploads/gallery/' . $item->image) }}" width="100" height="100">
                                </td>

                                <td>
                                    <button class="btn btn-sm btn-primary editBtn" data-id="{{ $item->id }}"
                                        data-title="{{ $item->title }}" data-image="{{ asset('uploads/gallery/' . $item->image) }}"data-url="{{ route('gallery.update', $item->id) }}">
                                        <i class="fa fa-edit"></i>
                                    </button>

                                    <button class="btn btn-sm btn-danger deleteBtn"
                                        data-id="{{ $item->id }}"
                                        data-url="{{ route('gallery.delete', $item->id) }}">
    ...
    <div class="modal fade" id="addCategoryModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" id="categoryForm" class="modal-content border-0 shadow-lg rounded-4"> @csrf <div
                    ...
                    <h5 class="modal-title fw-semibold">➕ Add Gallery</h5> <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                ...
                <div class="modal-footer border-0 px-4 pb-4"> <button type="button" class="btn btn-light"
                        data-bs-dismiss="modal" style="color: #ffff"> Cancel </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" id="editGalleryForm" action="#" class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-header border-0 px-4 pt-4">
                    <h5 class="modal-title fw-semibold">➕ Edit Category</h5> <button type="button" class="btn-close"
                ...
                <div class="modal-footer border-0 px-4 pb-4"> <button type="button" style="color: #ffff" class="btn btn-light"
